                        ...
                        <div class='card bg-common card-left'>
                            <div class="card-body">
                                <ul class="nav d-md-block d-none">
                                    <li class="nav-item">
                                        <a data-toggle="tab" class="nav-link active" href="#profile" style="cursor: not-allowed"><i
                                                class="fa fa-user mr-2"></i>User
                                            Profile</a>
                                    </li>
                                    <li class="nav-item">
                                        <a data-toggle="tab" class="nav-link" href="#add" style="cursor: not-allowed"><i
                                                class="fa fa-user-plus mr-2"></i>Add</a>
                                    </li>
                                    <li class="nav-item">
                                        <a data-toggle="tab" class="nav-link" href="#show_all" style="cursor: not-allowed"><i
                                ...
                                <div class="tab-pane active" id="profile">
                                    ...
                                    <form method="POST" action="update_record.php">
                                        ...
                                        <div>
                                            ...
                                            <input type="password" name="edit_password" value="<?= $row['password']; ?>"><br>
                                        </div><br>
                                        <div>
                                        ...
                                        <div>
                                        <a href="index.php" class="btn btn-danger" style="float: right;  margin-bottom: 17px;"
                                                name="cancel_btn">CANCEL</a>
                                            <button class="btn btn-success" style="float: right;  margin-bottom: 17px; margin-right: 5px;"
