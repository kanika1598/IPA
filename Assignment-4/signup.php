                ...
                <div class="card-body">
                    ...
                    <div class="input-group form-group"  required>
                        ...
                        <div>
                                        ...
                                        <div>
                                            <label class="text-white">QUALIFICATION:</label><br>
                                            <input type="checkbox" value="X" name="quali[]">X
                                            <input type="checkbox" value="XII" name="quali[]">XII
                                        </div>
                        <div>
                                <label for="photoFile" class="text-white">UPLOAD YOUR PHOTO</label><br>
                        <div>
                        <div class="input-group form-group"  required>
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-file-image"></i></span>
                            </div>
                            <input type="file" class="form-control" placeholder="Upload Photo" id="file" name="file" required>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn float-right register_btn" name="register_btn">REGISTER</button>
                        </div>
                    </form>
                </div>
            </div>
